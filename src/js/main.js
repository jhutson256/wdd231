...
function updateOverviewFromParkData(park) {
  ...
  const parkImage = document.getElementById("heroImg");
...
function buildHeaderMenuWithThen() {
  ...
  const headerMenuList = document.querySelector("#menuOptions ul");
...
function addEventListeners() {
  ...
  const parkMenu = document.querySelector("#parkMenu");
